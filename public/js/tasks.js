...
function renderTaskCard(t) {
  ...
  return `
    <div class="memory-card" style="padding:12px 16px;${isDone ? 'opacity:0.5;' : ''}">
      <div style="display:flex;align-items:flex-start;gap:10px;margin-bottom:${t.description || t.deadline || isInProgress ? '6px' : '0'};">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;margin-top:4px;margin-left:26px;">
